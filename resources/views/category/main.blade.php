    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Control category:</h6>
            <a class="collapse-item" href="/category/">View all category</a>
            <a class="collapse-item" href="{!! url('/category/create/') !!}">Create new category</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePosts" class="collapse" aria-labelledby="headingPosts" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Add/Edit/Create post:</h6>
            <a class="collapse-item" href="/post/">View all posts</a>
            <a class="collapse-item" href="{!! url('/post/create/') !!}">Create post</a>
          </div>
        </div>
      </li>
      ...
      <!-- <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Control category:</h6>
            <a class="collapse-item" href="/category/">View all category</a>
            <a class="collapse-item" href="/category/create/">Create new category</a>
          ...
          <p class="mb-4">
            <nav class="navbar navbar-inverse">
              <ul class="nav navbar-nav">
                  <li><a href="/category/">View all Category</a></li>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td>
                        <a href="{!! url('category/'.$category->id.'/edit') !!}" class="btn btn-primary btn-icon-split">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; {{ env('APP_AUTHOR') }} 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
